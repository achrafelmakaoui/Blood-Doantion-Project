		  ...
		  <div class="row">
			...
			<div class="footer-col">
			  ...
			  <div class="social-links">
                <a href="https://youtube.com/channel/UCEG7PifxvFfhjeCAYliw_Sg"><i class="fab fa-youtube" style="font-size: 15px;"></i></a>
				<a href="https://www.facebook.com/Blood-Donation-Company-112042261325179/"><i class="fab fa-facebook-f" style="font-size: 15px;"></i></a>
				<a href="https://twitter.com/bdcstaf?s=20&t=ZSuPKrRAz491GRsoCDXaHA"><i class="fab fa-twitter" style="font-size: 15px;"></i></a>
				<a href="https://instagram.com/b.d.c.team?utm_medium=copy_link"><i class="fab fa-instagram" style="font-size: 15px;"></i></a>
			  </div>
			</div>
		  </div>
		</div>
		<hr>
		<p class="copyright">All Rights Reserved © by <a href="https://www.linkedin.com/in/achraf-el-makaoui-851969242">ACHRAF EL MAKAOUI</a></p>
	 </footer>
</section>
  <script>
